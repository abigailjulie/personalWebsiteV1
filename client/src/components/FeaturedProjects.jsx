...
const projects = [
  {
    ...
    badges: ["Javascript", "React", "Node.js", "Express", "Vercel"],
  },
  {
    ...
    <>
      ...
      <div className="projects">
        ...
        <div className="featProjLinks">
          <Link className="link" to="/projects">View Software Projects Archive<i className="bi bi-arrow-right-short"></i></Link>
