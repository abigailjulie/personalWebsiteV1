...
export default function BackToTop() {
    ...
    const hideHomeLink = location.pathname === '/home';
    const hideProjectsLink = location.pathname === '/projects/architecture';


    const isProjectsPage = location.pathname === '/projects'; // Check if current page is '/projects';
    ...
    return (
        <Stack direction="horizontal" gap={2} className='badges'>
            ...
            {!hideHomeLink && (
                <Link to='/home' className='customBadgeLink homeLink'>
